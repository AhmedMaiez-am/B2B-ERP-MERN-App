...
const Container = tw(ContainerBase)`min-h-screen bg-gradient-to-b from-transparent via-transparent to-blue-300 text-white font-medium flex justify-center -m-8`;
    ...
    <Container>
      <Content>
        <MainContainer>
          ...
          <MainContent>
            <Heading>{headingText}</Heading><br/><br/>
            <FormContainer>
              <Form>
