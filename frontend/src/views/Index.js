          ...
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-32 sm:pt-0">
              <h2 className="font-semibold text-4xl text-blueGray-600">
                Votre portail web pour la gestion de vos affaires entre entreprises.
              </h2>
              <p className="mt-4 text-lg leading-relaxed text-blueGray-500">
                Toujours connecté avec votre espace Dynamics 365 Business Central.{" "}
                . Notre portail vous permet de gérer vos commandes, factures et bandes de livraison en temps réels et synchronisé avec Business Central. Ainsi que gérer votre ressources humaines et matériels.
              </p>
              <div className="mt-12">
                <a
                  href="/auth/login"
              ...
              <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-lightBlue-500">
                ...
                <blockquote className="relative p-8 mb-4">
                  ...
                  <h4 className="text-xl font-bold text-white">
                    Parfait pour la gestion de vos ressources volumineuses
                  </h4>
