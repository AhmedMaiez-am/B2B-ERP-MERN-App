...
const Link = tw.a`border-b-2 border-transparent hocus:text-gray-900 hocus:border-gray-900 pb-1 transition duration-300 mt-2 mx-4`;
    ...
    <Container>
      <Content>
        <Row>
          ...
          <CopyrightText>
            &copy; Copyright 2023, Smart Business Solutions. All Rights Reserved.
          </CopyrightText>
        </Row>
      </Content>
    </Container>
